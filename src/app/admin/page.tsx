        ...
        <div className="lg:col-span-2 space-y-12">
          <section className="bg-white rounded-[2.5rem] border border-black/5 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                ...
                <Input defaultValue="shabanimnango99@gmail" className="h-14 bg-black/[0.01] border-black/5 rounded-2xl font-bold" />
              </div>
              <div className="space-y-3">
              ...
              <div className="space-y-3">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-black/30">Base Currency</Label>
                <Input defaultValue="USD" className="h-14 bg-black/[0.01] border-black/5 rounded-2xl font-bold" />
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-[2.5rem] border border-black/5 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] space-y-8">
            <div className="flex items-center space-x-4 border-b border-black/5 pb-6">
              ...
              <h3 className="text-lg font-black uppercase tracking-widest">Security Matrix</h3>
            </div>
            <div className="space-y-6">
               {[
